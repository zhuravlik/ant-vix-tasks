 ...
 */
public class DeleteDirectory extends VixAction {
    ...
    public void executeAction(int vmHandle) {
        log("Deleting directory [" + path + "] in guest", Project.MSG_INFO);
        ...
        jobHandle = LibraryHelper.getInstance().VixVM_DeleteDirectoryInGuest(vmHandle,
                path,
                0,
                null,
                null);
