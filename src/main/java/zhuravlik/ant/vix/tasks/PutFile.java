 ...
 */
public class PutFile extends VixAction {
    ...
    public void executeAction(int vmHandle) {
        log("Copying file [" + path + "] to guest path [" + destination + "]", Project.MSG_INFO);
        ...
        jobHandle = Vix.INSTANCE.VixVM_CopyFileFromHostToGuest(vmHandle,
